...
class AuthControllerTest extends RecipeBaseIntegrationTest {
    ...
    void register_withInvalidRequest_shouldFail() throws Exception {
        String registerRequest = IntegrationTestUtils.toJson(DtoTestUtils.buildRegisterRequest(false));
    ...
    void login_withInvalidPassword_shouldFail() throws Exception {
        String loginRequest = IntegrationTestUtils.toJson(DtoTestUtils.buildLoginRequest(false));
        String registerRequest = IntegrationTestUtils.toJson(DtoTestUtils.buildRegisterRequest(true));
